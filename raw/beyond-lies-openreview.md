...
source: "openreview"
author: "Zhaomin Wu, Mingzhe Du, See-Kiong Ng, Bingsheng He"
date: "2026-04-23"
captured: "2026-05-13"
tags:
  - iclr-2026
...
The concerns of the reviewers are very diverse, thus I summarize the words of each reviewer separately.

**Reviewer 3gJd:** The concern of **3gJd** is minor, he/she mentions that a generalization to different domains should be mentioned in the future work.

**Reviewer 1Ppz:** The reviewer asks for a clearer discrimination between deception and hallucination as well as bias. Furthermore, he/she asks for a a comparison with prior benchmarks.

**Reviewer bKQQ:** The evaluation should be reexamined, as randomness lies in model sampling. The paper should discriminate between deception and hallucination.

## Review 1 (Reviewer_3gJd)
