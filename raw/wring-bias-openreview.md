...
source: "openreview"
author: "Walter Gerych, Cassandra Parent, Quinn Perian, Rafiya Javed, Justin Solomon et al."
date: "2026-04-23"
captured: "2026-05-13"
tags:
  - iclr-2026
...
The paper proposes WRING, a rotation-based debiasing method for vision–language model embeddings that aims to reduce bias for known concepts without amplifying bias for unconsidered ones. Unlike projection-based debiasing, WRING preserves relationships to other concepts by rotating embeddings within a relevant subspace rather than removing components. Theoretical analysis and experiments across multiple VLMs and datasets show reduced unintended bias amplification while maintaining comparable debiasing effectiveness.

## Review 1 (Reviewer_RKVo)
