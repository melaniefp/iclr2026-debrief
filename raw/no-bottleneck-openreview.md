...
source: "openreview"
author: "Antonio Almudévar, José Miguel Hernández-Lobato, Alfonso Ortega"
date: "2026-04-23"
captured: "2026-05-13"
tags:
  - iclr-2026
...
The paper proposes Minimal Concept Bottleneck Models (MCBM) to address the information leakage problem by enforcing the hidden representation z as a minimal sufficient statistics of concept c. Experiment show that MCBM demonstrate improved disentanglement and more stable concept-level interventions compared to CBM baselines. The reviewers primary concerns are addressed in the rebuttal and hence acceptance is recommended.

## Review 1 (Reviewer_dC8m)
