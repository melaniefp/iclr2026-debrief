...
source: "openreview"
author: "Jonathn Chang, Leonhard Piff, Suvadip Sana, Jasmine Xinze Li, Lionel Levine"
date: "2026-04-23"
captured: "2026-05-13"
tags:
  - iclr-2026
...
The reviewers generally agreed that the paper tackles an important and underexplored problem: quantitatively measuring subjective value alignment without ground-truth labels. The main concerns centered on the validity of the core assumption underlying EigenBench (that more aligned models are better judges), the limited scale of experiments (number/diversity of models and human judges), and the lack of empirical validation for proposed downstream applications such as character training. In their rebuttal and revision, the authors substantially strengthened the paper by adding new experiments, significantly expanding human validation, scaling up to a much larger and more diverse model population, and empirically demonstrating EigenBench as a target for character training. These additions directly address the reviewers’ methodological and empirical concerns, reinforcing the soundness, generality, and practical relevance of the proposed framework.

## Review 1 (Reviewer_M4QR)
