...
source: "openreview"
author: "Jing Yao, Shitong Duan, Xiaoyuan Yi, Dongkuan Xu, Peng Zhang et al."
date: "2026-04-23"
captured: "2026-05-13"
tags:
  - iclr-2026
...
The main concerns affecting the decision:
- generalizability beyond the Schwartz Value Survey
- validity/reliability assumptions for black-box probability estimates
- methodological design/analysis (e.g., EM-like procedure guarantees, hyperparameter justification, and potential bias induced by divergence-maximization)

Overall, the rebuttal has resolved most concerns, leading to an oral acceptance.

## Review 1 (Reviewer_SGLU)
